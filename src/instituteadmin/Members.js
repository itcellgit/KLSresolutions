                  ...
                  <table className="min-w-full divide-y divide-gray-200 table-fixed">
                    <thead className="bg-gray-50">
                      <tr>
                        ...
                        <th className="w-48 px-6 py-4 text-xs font-bold tracking-wider text-center text-gray-700 uppercase">
                          Member
                        </th>
                        <th className="w-48 px-6 py-4 text-xs font-bold tracking-wider text-center text-gray-700 uppercase">
                          Role
                        </th>
                        <th className="w-32 px-6 py-4 text-xs font-bold tracking-wider text-center text-gray-700 uppercase">
                          Level
                        </th>
                        <th className="px-6 py-4 text-xs font-bold tracking-wider text-center text-gray-700 uppercase w-52">
                          Institute
                        </th>
                        <th className="w-40 px-6 py-4 text-xs font-bold tracking-wider text-center text-gray-700 uppercase">
                          Tenure
                        </th>
                      </tr>
                    </thead>
                      ...
                      {!dataLoaded || tableLoading || dropdownLoading ? (
                        ...
                        currentItems.map((memberRole, idx) => (
                          <tr key={memberRole.id}>
                            ...
                            <td className="w-48 px-6 py-4 text-sm text-gray-500 break-words whitespace-nowrap">
                              {getMemberName(memberRole.member_id)}
                            </td>
                            <td className="w-48 px-6 py-4 text-sm text-gray-500 break-words whitespace-nowrap">
                              {getRoleName(memberRole.role_id)}
                            </td>
                            <td className="w-32 px-6 py-4 text-sm text-center text-gray-500 whitespace-nowrap">
                              <span
                            ...
                            <td className="px-6 py-4 text-sm text-gray-500 break-words whitespace-nowrap w-52">
                              {getInstituteName(memberRole.institute_id)}
                            </td>
                            <td className="w-40 px-6 py-4 text-sm text-gray-500 break-words whitespace-nowrap">
                              {memberRole.tenure}
                            </td>
                          </tr>
                        ))
