          ...
          <div className="p-6 bg-white shadow-xl rounded-xl">
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <Link
                ...
                className="flex flex-col items-center justify-center p-6 text-center transition-all duration-300 bg-indigo-50 rounded-lg hover:bg-indigo-100 hover:shadow-md"
              >
              ...
              <Link
                to="/members"
                className="flex flex-col items-center justify-center p-6 text-center transition-all duration-300 bg-green-50 rounded-lg hover:bg-green-100 hover:shadow-md"
              >
              ...
              <Link
                ...
                className="flex flex-col items-center justify-center p-6 text-center transition-all duration-300 bg-yellow-50 rounded-lg hover:bg-yellow-100 hover:shadow-md"
              >
              ...
              <Link
                ...
                className="flex flex-col items-center justify-center p-6 text-center transition-all duration-300 bg-red-50 rounded-lg hover:bg-red-100 hover:shadow-md"
              >
