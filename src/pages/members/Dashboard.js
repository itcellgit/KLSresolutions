...
const cardData = [
  {
    ...
    description: "Annual General Meeting decisions and corporate governance matters.",
    icon: "📋",
    link: "/member/agm-resolutions",
  },
  {
    title: "BOM Resolutions",
    description: "Board of Management strategic decisions and policy implementations.",
    icon: "⚖️",
    link: "/member/bom-resolutions",
  },
  {
    title: "GC Resolutions",
    description: "General Council administrative resolutions and procedural matters.",
    icon: "📄",
          ...
          {cardData.map((card, index) => (
            ...
            >
              <div className={`
                ...
                ${hoveredCard === index ? 'ring-2 ring-blue-500/30 shadow-blue-500/10' : ''}
              `}>
