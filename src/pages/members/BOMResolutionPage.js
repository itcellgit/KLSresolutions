...
//                   <span className="font-bold">{bomResolutions.length}</span>{" "}
//                   resolutions
//                 </span>
//               </div>
//             </div>
                                        ...
                                        (section) => {
                                          ...
                                          return (
                                            <div key={section} className="mb-6">
                                              <div className="mb-3 p-3 bg-indigo-100 border-l-4 border-indigo-500 rounded">
                                              ...
                                              <div className="space-y-4">
                                                {sectionItems.map(
                                                  (item, index) => (
                                                    ...
                                                    >
                                                      <div className="flex">
                                                        <div className="w-12 font-medium text-indigo-700">
                                                          {index + 1}.
                                                        </div>
