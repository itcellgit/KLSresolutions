...
export const getBOMResolutions = async (token) => {
  try {
    ...
    const response = await axios.get(`${API_BASE_URL}/bom_resolutions`, {
      headers,
    });
...
export const createBOMResolution = async (data, token) => {
  try {
    ...
    const response = await axios.post(`${API_BASE_URL}/bom_resolutions`, data, {
      headers,
    });
...
export const deleteBOMResolution = async (id, token) => {
  try {
    ...
    const response = await axios.delete(
      `${API_BASE_URL}/bom_resolutions/${id}`,
      {
        headers,
      }
    );
