    ...
    <header className="bg-gradient-to-r from-white via-indigo-50 to-indigo-100 border-b border-indigo-200 shadow-lg">
      <div className="flex items-center justify-between px-8 py-5">
        ...
        <div className="flex items-center gap-4">
          ...
          <img src={process.env.PUBLIC_URL + '/image.png'} alt="KLS Logo" className="w-14 h-14 rounded-full shadow-xl border-2 border-indigo-200 mr-4 hidden md:block" />
          <div className="flex flex-col justify-center">
            <h1 className="text-3xl md:text-4xl font-black text-indigo-700 tracking-wide font-serif mb-0 leading-tight drop-shadow-lg">KLS Resolutions</h1>
            <span className="text-sm font-semibold text-indigo-500 tracking-wide">Management Portal</span>
          </div>
        </div>
          ...
          {user && (
            <div className="hidden md:block">
              <span className="mr-2 text-base text-gray-700 font-semibold">
                Welcome, <span className="text-indigo-700 font-bold">{user.username}</span>
              </span>
            </div>
          )}
          <button
