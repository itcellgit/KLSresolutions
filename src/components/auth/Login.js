    ...
    <div className="min-h-screen flex items-center justify-center bg-white">
      <div className="w-full max-w-lg p-10 md:p-12 sm:p-8 bg-white shadow-2xl rounded-3xl border border-gray-200 flex flex-col justify-center">
        <div className="flex flex-col items-center mb-8">
          <img src={process.env.PUBLIC_URL + '/image.png'} alt="KLS Resolutions Logo" className="w-20 h-20 mb-4 rounded-full shadow" />
          <h1 className="text-3xl md:text-4xl font-extrabold text-indigo-700 mb-2 text-center">KLS Resolutions Portal</h1>
          <p className="text-gray-600 text-center text-base md:text-lg mb-2">A secure portal for KLS management and institutions to view and manage all GC and BOM resolutions, AGMs, and members.</p>
        </div>
        <h2 className="mb-8 text-2xl font-bold text-center text-gray-800">Login</h2>
        {(error || loginError) && (
        ...
        <form onSubmit={handleSubmit} className="space-y-7">
          <div>
            <label className="block mb-2 font-medium text-gray-700 text-base">Email</label>
            <input
              type="email"
              value={email}
          ...
          <div className="relative">
            <label className="block mb-2 font-medium text-gray-700 text-base">Password</label>
            <input
        ...
        <div className="mt-6 flex flex-col items-center">
          <a href="#" className="text-indigo-600 hover:underline text-sm md:text-base mb-2">Forgot Password?</a>
          <div className="text-xs text-gray-500 text-center">
            &copy; {new Date().getFullYear()} KLS Resolutions Portal. All rights reserved.
          </div>
        </div>
      </div>
    </div>
