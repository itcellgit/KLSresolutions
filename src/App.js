    ...
    <Provider store={store}>
      <Router>
        <Routes>
          ...
          />
          <Route
            path="/instituteadmin/gc"
            element={
              <PrivateRoute>
                {/* GC resolutions page for institute admin */}
                <AddGCResolution />
              </PrivateRoute>
            }
          />
          <Route
            ...
            element={
              <PrivateRoute>
                {/* BOM resolutions page for institute admin */}
                <BOMResolutionsInstitute />
              </PrivateRoute>
            }
          />
          <Route
            path="/instituteadmin/agm"
            element={
              <PrivateRoute>
                {/* AGM page for institute admin */}
                <AddAGM />
              </PrivateRoute>
            }
          />
          <Route
            ...
            element={
              <PrivateRoute>
                {/* Members page for institute admin */}
                <MembersInstitute />
              </PrivateRoute>
            }
          />
